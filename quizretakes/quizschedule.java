...
protected void start() throws IOException
{
        ...
        do
        {
                if (!validOption)
                {
                        System.out.println("Invalid entry. Valid entries are T, t, Teacher, teacher, S, s, Student, student.");
                        validOption = true;
                }

                System.out.println("Please enter if you are a teacher or a student."); //Prompt for student or teacher view
        ...
        do {
                filesValid = true;
                System.out.println("Please enter a valid course ID."); //Prompt for CourseID
...
protected void printQuizScheduleForm (PrintWriter out, Scanner in, quizzes quizList, retakes retakesList, courseBean course, String signInOption) throws IOException
{
        ...
        String apts = dataLocation + apptsBase + "-" + course.getCourseID() +".txt";
        File file = new File(apts);
